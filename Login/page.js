               ...
               <div className="text-black w-3/2 p-3 text-center">
                ...
                <div className="flex flex-col items-center">
                  ...
                  <div className="bg-gray-100 w-64 p-2 flex items-center mb-3"><SiNamecheap  className="text-gray-400 m-2"/>
                   <input type="user name" name="user name" placeholder="User Name" className="bg-gray-100 outline-none text-sm flex-1"/>
                  </div>
                  ...
                  <a href="#" className="border-2 border-black-1000 text-black-500 rounded-full px-12 py-2 inline-block font-semibold hover:bg-black-500 hover:text-white">Log-in</a>
